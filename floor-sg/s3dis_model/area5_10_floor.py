...
def genModel(path_roomBound, color_lst = None, path_ori_point_cloud=None, path_save=None, isExtrude=True, show_cap=True, show_edge=False):
    ...
    if path_ori_point_cloud is None:
        ...
        for i, room in enumerate(new_data):
            print(i)
            if i!=5 and i!=51 and i!=52 and i!=53 and i!=54:
                continue
...
if __name__ == '__main__':
    ...
    roomBound = 'area5_wall.txt'
    path_save_mesh = 'E:\\FloorSG\\code\\S3DIS_total\\data\\area5\\floor\\'
    color_lst = get_color_lst(r'C:\2024\Code\FloorSG\Seg\area5_color.mat', r'E:\FloorSG\Expriment_output\S3DIS\Boundary_optim\area5.txt')
