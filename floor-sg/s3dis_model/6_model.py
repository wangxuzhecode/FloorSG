...
roomBound = 'area6_wall.txt'
door_path = 'area6_project_door.txt'
window_path = 'area6_project_window.txt'
...
path_dir = r"E:\FloorSG\Expriment_output\S3DIS\wall_area6\*.txt"
...
combined_mesh.save('area6_wall.obj')
