...
path_dir = "C:\\2024\\FloorSG\\Matterport3d_scene3\\"
# txt_files = glob.glob(path_dir)
output_path = 'E:\\FloorSG\\Expriment_output\\S3DIS\\wall_scene3\\'
out_path = 'scene3_wall.txt'
height = 2.2
...
with open(out_path, 'w', encoding='utf-8') as f1:
    for i in range(1, 22):
        ...
        txt_file2 = os.path.join(path_dir, str(i)+'.txt')
        ...
        with open(os.path.join(output_path, os.path.basename(txt_file2)), 'w', encoding='utf-8') as f:
            for line in merged5:
