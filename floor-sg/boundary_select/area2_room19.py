    ...
    for i in range(24,25):
        ...
        for num, seg in enumerate(merged_segments):
            ...
            if length<5:
                ...
                continue
            if length >= 3 or num == len(merged_segments)-1:
        ...
        cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.1, thres_angle=1, points=np.vstack(cur_points))
