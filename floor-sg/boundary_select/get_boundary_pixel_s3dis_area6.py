...
def get_points_by_roomline(roomline, points, theta = 20):
    gridsize = 0.1
    min_data = [-21.233000000000000, -2.604500000000000]
...
if __name__ == '__main__':
    ...
    area_name = r'E:\FloorSG\Expriment_output\S3DIS\Boundary_optim\area6.txt'
    ...
    point_path = r'E:\Stanford3dDataset_v1.2\Area_6\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\area6'
    matrix = []
    ...
    for i in range(35,36):
        ...
        for num, seg in enumerate(merged_segments):
            ...
            if selected_points.shape[0] < theta or k==None:
                # print(k, mode)
                if k == None:
        ...
        cur_path = os.path.join(output_path, str(i+103))
        if not os.path.exists(cur_path):
            os.makedirs(cur_path)
        cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.1, thres_angle= 0.7, points=np.vstack(cur_points))
