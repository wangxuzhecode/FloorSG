...
def get_points_by_roomline(roomline, points, theta = 80):
    gridsize = 0.12
...
def ransac_line_fitting(points, iterations=15000, threshold=0.05):
    best_inliers = []
    best_m = None
    best_b = None
...
if __name__ == '__main__':
    ...
    point_path = r'C:\2024\data\ISPRS\TUB1\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\tub1'
    matrix = []
    ...
    for i in range(12, 13):
        ...
        # cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.1, thres_angle= 0.01, points=np.vstack(cur_points))
