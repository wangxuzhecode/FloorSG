...
def get_points_by_roomline(roomline, points, theta = 100):
    gridsize = 0.25/4
    min_data = [-14.099610328674316, -10.322282791137695]
...
if __name__ == '__main__':
    ...
    area_name = r'E:\FloorSG\Expriment_output\Matterport3d\q9vSo1VnCiC_filter_resize.txt'
    ...
    point_path = r'E:\matterport3d_used\q9vSo1VnCiC\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\scene2'
    matrix = []
    ...
    for i in range(1, 28):
        ...
        for num, seg in enumerate(merged_segments):
            ...
            # with open(roomline_path, "a") as f:2
