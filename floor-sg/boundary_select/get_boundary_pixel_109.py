...
def get_points_by_roomline(roomline, points, theta = 20):
    gridsize = 0.1
    min_data = [-0.742600200000000, -1.620300050000000]
    height = 293
    width = 258
...
if __name__ == '__main__':
    ...
    area_name = r'E:\FloorSG\MRF_test\test_109\MRF_filter_refine_filter_res_pad.txt'
    ...
    point_path = r'E:\data\vertical_sub.txt'
    output_path = r'E:\FloorSG\MRF_test\test_109\109_vector'
    matrix = []
    ...
    for i in range(1,2):
        ...
        for num, seg in enumerate(merged_segments):
            ...
            if selected_points.shape[0]< theta/2 and length<4:
                continue
        ...
        cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.01, thres_angle= 4, points=np.vstack(cur_points))
