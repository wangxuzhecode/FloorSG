...
def get_points_by_roomline(roomline, points, theta = 20):
    gridsize = 0.1
    min_data = [-12.968329430000000, -27.340354920000000]
...
if __name__ == '__main__':
    ...
    area_name = r'C:\2024\data\ISPRS\TUB2\MRF_filter_refine_filter_res_pad.txt'
    ...
    point_path = r'C:\2024\data\ISPRS\TUB2\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\tub2'
    matrix = []
    ...
    for i in range(3,4):
        ...
        cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.1, thres_angle= 0.1, points=np.vstack(cur_points))
