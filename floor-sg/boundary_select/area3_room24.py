...
def get_points_by_roomline(roomline, points, theta = 20):
    gridsize = 0.1
    min_data = [-1.513000000000000, -16.332500000000000]
    height = 344
    width = 570
...
if __name__ == '__main__':
    ...
    area_name = r'E:\FloorSG\Expriment_output\S3DIS\Boundary_optim\area3.txt'
    ...
    point_path = r'E:\Stanford3dDataset_v1.2\Area_3\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\area3'
    matrix = []
