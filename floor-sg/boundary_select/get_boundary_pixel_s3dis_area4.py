...
def get_points_by_roomline(roomline, points, theta = 20):
    gridsize = 0.1
    min_data = [-29.712000000000000, -4.840500000000000]
...
def remove_similar_lines(lines, thres_dist, thres_angle, points):
    ...
    for i,line1 in enumerate(lines):
        # if calculate_length_line(line1)>10:
        #     continue
...
if __name__ == '__main__':
    ...
    area_name = r'E:\FloorSG\Expriment_output\S3DIS\Boundary_optim\area4.txt'
    ...
    point_path = r'E:\Stanford3dDataset_v1.2\Area_4\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\area4'
    matrix = []
    ...
    for i in range(37,38):
        ...
        cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.1, thres_angle= 3, points=np.vstack(cur_points))
