...
def get_points_by_roomline(roomline, points, theta = 100):
    gridsize = 0.23/4
    min_data = [-3.167572980000000, -5.179801940917969]
...
def ransac_line_fitting(points, iterations=5000, threshold=0.05):
    best_inliers = []
    best_m = None
    best_b = None
...
if __name__ == '__main__':
    ...
    point_path = r'E:\matterport3d_used\zsNo4HB9uLZ\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\scene3'
    matrix = []
