...
if __name__ == '__main__':
    ...
    point_path = r'E:\Stanford3dDataset_v1.2\Area_1\vertical_sub.txt'
    output_path = r'C:\2024\FloorSG\S3DIS_vector\area1'
    matrix = []
    ...
    for i in range(1,5):
        ...
        cur_room_lineseg = remove_similar_lines(cur_room_lineseg, thres_dist=0.1, thres_angle= 5, points=np.vstack(cur_points))
